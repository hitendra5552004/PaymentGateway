...
namespace Infrastructure.CrossCuting.Serialization
{
    ...
    /*
        ...
        CreateSaleResponse teste = serializer.DeserializeObject<CreateSaleResponse>(RawResponse);
        string devolta = serializer.SerializeObject<CreateSaleResponse>(teste);
    */
